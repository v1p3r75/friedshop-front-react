            ...
            <div className='position-absolute fw-bold top-0 end-0 w-25 p-3 bg-white h-100 text-black' style={{ zIndex: '2' }}>
                ...
                <div className="overflow-auto">
                    <form action="" method="post" className='w-100 d-flex'>
                        ...
                        <div className='w-25'><button type='submit' className='btn-outline-none border-0 fd-bg-primary rounded-0 py-3 px-4'><i className="bi bi-search w-100"></i></button></div>
                    </form>
                </div>
